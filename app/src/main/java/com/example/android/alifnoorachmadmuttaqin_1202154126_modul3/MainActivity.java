...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //membuat variabel int untuk set ukuran kolom saat landscape dan potrait
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        mRecyclerView = findViewById(R.id.recyclerView);
        //referensi recyclerview dari activity_main.xml
        mRecyclerView.setLayoutManager(new GridLayoutManager(this, gridColumnCount));
        //set layout untuk menampilkan kolom gambar
        mMainData = new ArrayList<>();
        //objek baru pada ArrayList
        mAdapter = new MainAdapter (this, mMainData);
        //membuat objek baru pada MainAdapter
