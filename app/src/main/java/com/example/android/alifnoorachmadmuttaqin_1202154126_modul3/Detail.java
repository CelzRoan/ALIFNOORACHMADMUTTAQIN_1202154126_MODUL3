...
public class Detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mainTitle = findViewById(R.id.titleDetail);
        ImageView mainImage = findViewById(R.id.ImageDetail);
        ImageView air = findViewById(R.id.air);
        int water = 0;
        //memberi nilai awal pada variabel water
        air.setImageLevel(water);
        //set level pada gambar dengan id air
        ...
        Glide.with(this).load(getIntent().getIntExtra(Main.IMAGE_KEY, 0))
                .placeholder(gradientDrawable).into(mainImage);
    }
    public void IncreaseScore(View view) {
        //method untuk menambah banyak air
        ImageView air = findViewById(R.id.air);
        //referensi ImageView
        count = findViewById(R.id.count);
        //referensi TextView
        int max = 6;
        //menset value pada variabel max
        if (water < max){
            //mangatur kondisi
            water++;
            //incerement
            ...
            //menampilkan text pada variabel count
            if (water == max){
                //kondisi jika water mencapai maximal
                Toast.makeText(this, "Air Sudah Penuh", Toast.LENGTH_SHORT).show();
                //menampilkan toast air penuh
            }
        }
    }
    public void DecreaseScore(View view) {
        //method untuk mengurangi bnyak air
        ImageView air = findViewById(R.id.air);
        count = findViewById(R.id.count);
        int min = 0;
        //set value min
