...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder>{
    ...
    MainAdapter (Context context, ArrayList<Main> MainData){
        ...
        //membuat objek baru GradientDrwable
        mGradientDrawable.setColor(Color.GRAY);
        //set warna abu - abu pada objek GradientDrawable
    }
    @Override
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MainViewHolder(mContext, LayoutInflater.from(mContext).inflate(R.layout.activity_main2, parent,
    ...
    public void onBindViewHolder(MainViewHolder holder, int position) {
        ...
        //mendapatkan posisi penampilkan data
        holder.bindTo(currentMain);
    }
    @Override
    public int getItemCount() {
        return mMainData.size();
        //mendapatkan ukuran item
    }
    ...
    public class MainViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        MainViewHolder(Context context, View itemView, GradientDrawable gradientDrawable) {
            ...
            mMainImage = itemView.findViewById(R.id.mainImage);
            mContext = context ;
        ...
        public void bindTo(Main currentMain) {
            ...
            //mensetting Text dari method getTitle
            mInfoText.setText(currentMain.getInfo());
            //mensetting text yang berisi info dari method getInfo
